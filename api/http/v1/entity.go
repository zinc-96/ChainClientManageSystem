...
const (
	...
	CodeCreateCertErr      ErrCode = 10009 // 创建证书错误
	CodeQueryCertErr       ErrCode = 10010 // 查询证书错误
	CodeInitChainClientErr ErrCode = 10011 // 保存链客户端错误
	CodeGetChainClientErr  ErrCode = 10012 // 获取链客户端错误
	CodeTestContractErr    ErrCode = 10013 // 测试合约错误
)
